...
#define OS_CFG_IDLE_TASK_STK_LIMIT                                             \
	((OS_CFG_IDLE_TASK_STK_SIZE * OS_CFG_TASK_STK_LIMIT_PCT_EMPTY) / 100u)
#define OS_CFG_INT_Q_TASK_STK_LIMIT                                            \
	((OS_CFG_INT_Q_TASK_STK_SIZE * OS_CFG_TASK_STK_LIMIT_PCT_EMPTY) / 100u)
#define OS_CFG_STAT_TASK_STK_LIMIT                                             \
	((OS_CFG_STAT_TASK_STK_SIZE * OS_CFG_TASK_STK_LIMIT_PCT_EMPTY) / 100u)
#define OS_CFG_TICK_TASK_STK_LIMIT                                             \
	((OS_CFG_TICK_TASK_STK_SIZE * OS_CFG_TASK_STK_LIMIT_PCT_EMPTY) / 100u)
#define OS_CFG_TMR_TASK_STK_LIMIT                                              \
	((OS_CFG_TMR_TASK_STK_SIZE * OS_CFG_TASK_STK_LIMIT_PCT_EMPTY) / 100u)
...
CPU_STK_SIZE const OSCfg_IdleTaskStkLimit =
	(CPU_STK_SIZE)OS_CFG_IDLE_TASK_STK_LIMIT;
CPU_STK_SIZE const OSCfg_IdleTaskStkSize =
	(CPU_STK_SIZE)OS_CFG_IDLE_TASK_STK_SIZE;
CPU_INT32U const OSCfg_IdleTaskStkSizeRAM =
	(CPU_INT32U)sizeof(OSCfg_IdleTaskStk);
...
CPU_STK_SIZE const OSCfg_IntQTaskStkLimit =
	(CPU_STK_SIZE)OS_CFG_INT_Q_TASK_STK_LIMIT;
CPU_STK_SIZE const OSCfg_IntQTaskStkSize =
	(CPU_STK_SIZE)OS_CFG_INT_Q_TASK_STK_SIZE;
CPU_INT32U const OSCfg_IntQTaskStkSizeRAM =
...
CPU_STK_SIZE const OSCfg_StatTaskStkLimit =
	(CPU_STK_SIZE)OS_CFG_STAT_TASK_STK_LIMIT;
CPU_STK_SIZE const OSCfg_StatTaskStkSize =
	(CPU_STK_SIZE)OS_CFG_STAT_TASK_STK_SIZE;
CPU_INT32U const OSCfg_StatTaskStkSizeRAM =
	(CPU_INT32U)sizeof(OSCfg_StatTaskStk);
#else
...
CPU_STK_SIZE const OSCfg_TickTaskStkLimit =
	(CPU_STK_SIZE)OS_CFG_TICK_TASK_STK_LIMIT;
CPU_STK_SIZE const OSCfg_TickTaskStkSize =
	(CPU_STK_SIZE)OS_CFG_TICK_TASK_STK_SIZE;
CPU_INT32U const OSCfg_TickTaskStkSizeRAM =
	(CPU_INT32U)sizeof(OSCfg_TickTaskStk);
...
CPU_STK_SIZE const OSCfg_TmrTaskStkLimit =
	(CPU_STK_SIZE)OS_CFG_TMR_TASK_STK_LIMIT;
CPU_STK_SIZE const OSCfg_TmrTaskStkSize =
	(CPU_STK_SIZE)OS_CFG_TMR_TASK_STK_SIZE;
...
#if (OS_CFG_ISR_POST_DEFERRED_EN > 0u)
	+ sizeof(OSCfg_IntQ) + sizeof(OSCfg_IntQTaskStk)
#endif
...
#if (OS_CFG_TMR_EN > 0u)
	+ sizeof(OSCfg_TmrTaskStk) + sizeof(OSCfg_TmrWheel)
#endif

#if (OS_CFG_ISR_STK_SIZE > 0u)
	+ sizeof(OSCfg_ISRStk)
#endif
	+ sizeof(OSCfg_TickTaskStk) + sizeof(OSCfg_TickWheel);
