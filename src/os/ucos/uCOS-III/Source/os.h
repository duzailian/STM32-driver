...
#define OS_VERSION                                                             \
	30301u /* Version of uC/OS-III (Vx.yy.zz mult. by 10000)                   */
...
/* ------------------- TASK STATES ------------------ */
#define OS_TASK_STATE_BIT_DLY                                                  \
	(OS_STATE)(                                                            \
		0x01u) /*   /-------- SUSPENDED bit                          */
/*   |                                                */
#define OS_TASK_STATE_BIT_PEND                                                 \
	(OS_STATE)(                                                            \
		0x02u) /*   | /-----  PEND      bit                          */
/*   | |                                              */
#define OS_TASK_STATE_BIT_SUSPENDED                                            \
	(OS_STATE)(                                                            \
		0x04u) /*   | | /---  Delayed/Timeout bit                    */
/*   | | |                                            */
/*   V V V                                            */

#define OS_TASK_STATE_RDY                                                      \
	(OS_STATE)(0u) /*   0 0 0     Ready                                  */
#define OS_TASK_STATE_DLY                                                      \
	(OS_STATE)(1u) /*   0 0 1     Delayed or Timeout                     */
#define OS_TASK_STATE_PEND                                                     \
	(OS_STATE)(2u) /*   0 1 0     Pend                                   */
#define OS_TASK_STATE_PEND_TIMEOUT                                             \
	(OS_STATE)(3u) /*   0 1 1     Pend + Timeout                         */
#define OS_TASK_STATE_SUSPENDED                                                \
	(OS_STATE)(4u) /*   1 0 0     Suspended                              */
#define OS_TASK_STATE_DLY_SUSPENDED                                            \
	(OS_STATE)(5u) /*   1 0 1     Suspended + Delayed or Timeout         */
#define OS_TASK_STATE_PEND_SUSPENDED                                           \
	(OS_STATE)(6u) /*   1 1 0     Suspended + Pend                       */
#define OS_TASK_STATE_PEND_TIMEOUT_SUSPENDED                                   \
	(OS_STATE)(7u) /*   1 1 1     Suspended + Pend + Timeout             */
#define OS_TASK_STATE_DEL (OS_STATE)(255u)

/* ----------------- PENDING ON ... ----------------- */
#define OS_TASK_PEND_ON_NOTHING                                                \
	(OS_STATE)(0u) /* Pending on nothing                                 */
#define OS_TASK_PEND_ON_FLAG                                                   \
	(OS_STATE)(1u) /* Pending on event flag group                        */
#define OS_TASK_PEND_ON_TASK_Q                                                 \
	(OS_STATE)(2u) /* Pending on message to be sent to task              */
#define OS_TASK_PEND_ON_MULTI                                                  \
	(OS_STATE)(3u) /* Pending on multiple semaphores and/or queues       */
#define OS_TASK_PEND_ON_MUTEX                                                  \
	(OS_STATE)(4u) /* Pending on mutual exclusion semaphore              */
#define OS_TASK_PEND_ON_Q                                                      \
	(OS_STATE)(5u) /* Pending on queue                                   */
#define OS_TASK_PEND_ON_SEM                                                    \
	(OS_STATE)(6u) /* Pending on semaphore                               */
#define OS_TASK_PEND_ON_TASK_SEM                                               \
	(OS_STATE)(7u) /* Pending on signal  to be sent to task              */
...
#define OS_STATUS_PEND_OK                                                      \
	(OS_STATUS)(0u) /* Pending status OK, !pending, or pending complete   */
#define OS_STATUS_PEND_ABORT                                                   \
	(OS_STATUS)(1u) /* Pending aborted                                    */
#define OS_STATUS_PEND_DEL                                                     \
	(OS_STATUS)(2u) /* Pending object deleted                             */
#define OS_STATUS_PEND_TIMEOUT                                                 \
	(OS_STATUS)(3u) /* Pending timed out                                  */
...
#define OS_OBJ_TYPE_TASK_RESUME                                                \
	(OS_OBJ_TYPE) CPU_TYPE_CREATE('T', 'R', 'E', 'S')
#define OS_OBJ_TYPE_TASK_SIGNAL                                                \
	(OS_OBJ_TYPE) CPU_TYPE_CREATE('T', 'S', 'I', 'G')
#define OS_OBJ_TYPE_TASK_SUSPEND                                               \
	(OS_OBJ_TYPE) CPU_TYPE_CREATE('T', 'S', 'U', 'S')
...
#define OS_OPT_PEND_FLAG_CLR_ALL                                               \
	(OS_OPT)(                                                              \
		0x0001u) /* Wait for ALL    the bits specified to be CLR       */
#define OS_OPT_PEND_FLAG_CLR_AND (OS_OPT)(0x0001u)

#define OS_OPT_PEND_FLAG_CLR_ANY                                               \
	(OS_OPT)(                                                              \
		0x0002u) /* Wait for ANY of the bits specified to be CLR       */
#define OS_OPT_PEND_FLAG_CLR_OR (OS_OPT)(0x0002u)

#define OS_OPT_PEND_FLAG_SET_ALL                                               \
	(OS_OPT)(                                                              \
		0x0004u) /* Wait for ALL    the bits specified to be SET       */
#define OS_OPT_PEND_FLAG_SET_AND (OS_OPT)(0x0004u)

#define OS_OPT_PEND_FLAG_SET_ANY                                               \
	(OS_OPT)(                                                              \
		0x0008u) /* Wait for ANY of the bits specified to be SET       */
#define OS_OPT_PEND_FLAG_SET_OR (OS_OPT)(0x0008u)

#define OS_OPT_PEND_FLAG_CONSUME                                               \
	(OS_OPT)(                                                              \
		0x0100u) /* Consume the flags if condition(s) satisfied        */
...
#define OS_OPT_PEND_ABORT_1                                                    \
	(OS_OPT)(                                                              \
		0x0000u) /* Pend abort a single waiting task                   */
#define OS_OPT_PEND_ABORT_ALL                                                  \
	(OS_OPT)(                                                              \
		0x0100u) /* Pend abort ALL tasks waiting                       */
...
#define OS_OPT_POST_FIFO                                                       \
	(OS_OPT)(                                                              \
		0x0000u) /* Default is to post FIFO                            */
#define OS_OPT_POST_LIFO                                                       \
	(OS_OPT)(                                                              \
		0x0010u) /* Post to highest priority task waiting              */
#define OS_OPT_POST_1                                                          \
	(OS_OPT)(                                                              \
		0x0000u) /* Post message to highest priority task waiting      */
#define OS_OPT_POST_ALL                                                        \
	(OS_OPT)(                                                              \
		0x0200u) /* Broadcast message to ALL tasks waiting             */

#define OS_OPT_POST_NO_SCHED                                                   \
	(OS_OPT)(                                                              \
		0x8000u) /* Do not call the scheduler if this is selected      */
...
#define OS_OPT_TASK_NONE                                                       \
	(OS_OPT)(                                                              \
		0x0000u) /* No option selected                                 */
#define OS_OPT_TASK_STK_CHK                                                    \
	(OS_OPT)(                                                              \
		0x0001u) /* Enable stack checking for the task                 */
#define OS_OPT_TASK_STK_CLR                                                    \
	(OS_OPT)(                                                              \
		0x0002u) /* Clear the stack when the task is create            */
#define OS_OPT_TASK_SAVE_FP                                                    \
	(OS_OPT)(                                                              \
		0x0004u) /* Save the contents of any floating-point registers  */
#define OS_OPT_TASK_NO_TLS                                                     \
	(OS_OPT)(                                                              \
		0x0008u) /* Specifies the task DOES NOT require TLS support    */
...
#define OS_OPT_TIME_MASK                                                       \
	((OS_OPT)(OS_OPT_TIME_DLY | OS_OPT_TIME_TIMEOUT |                      \
		  OS_OPT_TIME_PERIODIC | OS_OPT_TIME_MATCH))

#define OS_OPT_TIME_OPTS_MASK                                                  \
	(OS_OPT_TIME_DLY | OS_OPT_TIME_TIMEOUT | OS_OPT_TIME_PERIODIC |        \
	 OS_OPT_TIME_MATCH | OS_OPT_TIME_HMSM_NON_STRICT)
...
#define OS_OPT_TMR_NONE                                                        \
	(OS_OPT)(0u) /* No option selected                                 */

#define OS_OPT_TMR_ONE_SHOT                                                    \
	(OS_OPT)(1u) /* Timer will not auto restart when it expires        */
#define OS_OPT_TMR_PERIODIC                                                    \
	(OS_OPT)(2u) /* Timer will     auto restart when it expires        */

#define OS_OPT_TMR_CALLBACK                                                    \
	(OS_OPT)(3u) /* OSTmrStop() option to call 'callback' w/ timer arg */
#define OS_OPT_TMR_CALLBACK_ARG                                                \
	(OS_OPT)(4u) /* OSTmrStop() option to call 'callback' w/ new   arg */
...
#define OS_TICK_TH_INIT                                                        \
	(OS_TICK)(DEF_BIT((sizeof(OS_TICK) * DEF_OCTET_NBR_BITS) - 1u))

/* Threshold to check if tick time already ready  */
#define OS_TICK_TH_RDY                                                         \
	(OS_TICK)(                                                             \
		DEF_BIT_FIELD(((sizeof(OS_TICK) * DEF_OCTET_NBR_BITS) / 2u),   \
...
typedef void (*OS_TLS_DESTRUCT_PTR)(OS_TCB *p_tcb, OS_TLS_ID id, OS_TLS value);
#endif
...
struct os_int_q {
	OS_OBJ_TYPE
		Type; /* Type of object placed in the circular list             */
	...
	OS_MSG_SIZE
		MsgSize; /* Message Size       if posting to a message queue       */
...
struct os_rdy_list {
	...
	OS_OBJ_QTY
		NbrEntries; /* Number of entries             at selected priority     */
};
...
struct os_pend_obj {
	...
	CPU_CHAR *NamePtr;
	OS_PEND_LIST
		PendList; /* List of tasks pending on object                        */
#if OS_CFG_DBG_EN > 0u
	void *DbgPrevPtr;
	void *DbgNextPtr;
	CPU_CHAR *DbgNamePtr;
...
struct os_flag_grp { /* Event Flag Group                                       */
	/* ------------------ GENERIC  MEMBERS ------------------ */
	OS_OBJ_TYPE
		Type; /* Should be set to OS_OBJ_TYPE_FLAG                      */
	CPU_CHAR *NamePtr; /* Pointer to Event Flag Name (NUL terminated ASCII)      */
	OS_PEND_LIST
		PendList; /* List of tasks waiting on event flag group              */
#if OS_CFG_DBG_EN > 0u
...
struct os_mem { /* MEMORY CONTROL BLOCK                                   */
	OS_OBJ_TYPE
		Type; /* Should be set to OS_OBJ_TYPE_MEM                       */
	void *AddrPtr; /* Pointer to beginning of memory partition               */
	CPU_CHAR *NamePtr;
	void *FreeListPtr; /* Pointer to list of free memory blocks                  */
	OS_MEM_SIZE
		BlkSize; /* Size (in bytes) of each block of memory                */
	OS_MEM_QTY
		NbrMax; /* Total number of blocks in this partition               */
	OS_MEM_QTY
		NbrFree; /* Number of memory blocks remaining in this partition    */
#if OS_CFG_DBG_EN > 0u
	OS_MEM *DbgPrevPtr;
	OS_MEM *DbgNextPtr;
#endif
...
struct os_msg_pool { /* OS_MSG POOL                                            */
	OS_MSG *NextPtr; /* Pointer to next message                                */
	OS_MSG_QTY
		NbrFree; /* Number of messages available from this pool            */
	OS_MSG_QTY
		NbrUsed; /* Current number of messages used                        */
	OS_MSG_QTY
		NbrUsedMax; /* Peak number of messages used                           */
};
...
struct os_msg_q { /* OS_MSG_Q                                               */
	...
	OS_MSG_QTY
		NbrEntriesSize; /* Maximum allowable number of entries in the queue       */
	OS_MSG_QTY
		NbrEntries; /* Current number of entries in the queue                 */
	OS_MSG_QTY
		NbrEntriesMax; /* Peak number of entries in the queue                    */
};
...
struct os_mutex { /* Mutual Exclusion Semaphore                             */
	/* ------------------ GENERIC  MEMBERS ------------------ */
	OS_OBJ_TYPE
		Type; /* Should be set to OS_OBJ_TYPE_MUTEX                     */
	CPU_CHAR *NamePtr; /* Pointer to Mutex Name (NUL terminated ASCII)           */
	OS_PEND_LIST
		PendList; /* List of tasks waiting on mutex                         */
#if OS_CFG_DBG_EN > 0u
	OS_MUTEX *DbgPrevPtr;
	OS_MUTEX *DbgNextPtr;
	CPU_CHAR *DbgNamePtr;
	...
	OS_NESTING_CTR
		OwnerNestingCtr; /* Mutex is available when the counter is 0               */
	CPU_TS TS;
};
...
struct os_q { /* Message Queue                                          */
	/* ------------------ GENERIC  MEMBERS ------------------ */
	OS_OBJ_TYPE
		Type; /* Should be set to OS_OBJ_TYPE_Q                         */
	CPU_CHAR *NamePtr; /* Pointer to Message Queue Name (NUL terminated ASCII)   */
	OS_PEND_LIST
		PendList; /* List of tasks waiting on message queue                 */
#if OS_CFG_DBG_EN > 0u
	OS_Q *DbgPrevPtr;
	OS_Q *DbgNextPtr;
	CPU_CHAR *DbgNamePtr;
...
struct os_sem { /* Semaphore                                              */
	/* ------------------ GENERIC  MEMBERS ------------------ */
	OS_OBJ_TYPE
		Type; /* Should be set to OS_OBJ_TYPE_SEM                       */
	CPU_CHAR *NamePtr; /* Pointer to Semaphore Name (NUL terminated ASCII)       */
	OS_PEND_LIST
		PendList; /* List of tasks waiting on semaphore                     */
#if OS_CFG_DBG_EN > 0u
	OS_SEM *DbgPrevPtr;
	OS_SEM *DbgNextPtr;
	CPU_CHAR *DbgNamePtr;
...
struct os_tcb {
	...
	OS_TICK_SPOKE *
		TickSpokePtr; /* Pointer to tick spoke if task is in the tick list      */
	...
	OS_TASK_PTR
		TaskEntryAddr; /* Pointer to task entry point address                    */
	void *TaskEntryArg; /* Argument passed to task when it was created            */

	OS_PEND_DATA *
		PendDataTblPtr; /* Pointer to list containing objects pended on           */
	...
	CPU_STK_SIZE
		StkSize; /* Size of task stack (in number of stack elements)       */
	OS_OPT Opt; /* Task options as passed by OSTaskCreate()               */

	OS_OBJ_QTY
		PendDataTblEntries; /* Size of array of objects to pend on                    */

	CPU_TS TS; /* Timestamp                                              */

	OS_SEM_CTR
		SemCtr; /* Task specific semaphore counter                        */
	...
	OS_NESTING_CTR
		SuspendCtr; /* Nesting counter for OSTaskSuspend()                    */
#endif

#if OS_CFG_TASK_PROFILE_EN > 0u
	OS_CPU_USAGE
		CPUUsage; /* CPU Usage of task (0.00-100.00%)                       */
	OS_CPU_USAGE
		CPUUsageMax; /* CPU Usage of task (0.00-100.00%) - Peak                */
	OS_CTX_SW_CTR
		CtxSwCtr; /* Number of time the task was switched in                */
	...
	CPU_STK_SIZE
		StkUsed; /* Number of stack elements used from the stack           */
	CPU_STK_SIZE
		StkFree; /* Number of stack elements free on   the stack           */
#endif
...
struct os_tick_spoke {
	...
	OS_OBJ_QTY
		NbrEntries; /* Current number of entries in the tick spoke            */
	OS_OBJ_QTY
		NbrEntriesMax; /* Peak number of entries in the tick spoke               */
};
...
struct os_tmr {
	...
	OS_TMR_CALLBACK_PTR
		CallbackPtr; /* Function to call when timer expires                    */
...
#if OS_CFG_APP_HOOKS_EN > 0u
OS_EXT OS_APP_HOOK_TCB
	OS_AppTaskCreateHookPtr; /* Application hooks                          */
...
/* MISCELLANEOUS ---------------------------- */
OS_EXT OS_NESTING_CTR
	OSIntNestingCtr; /* Interrupt nesting level                    */
#ifdef CPU_CFG_INT_DIS_MEAS_EN
...
/* READY LIST ------------------------------- */
OS_EXT OS_RDY_LIST OSRdyList
	[OS_CFG_PRIO_MAX]; /* Table of tasks ready to run                */

#ifdef OS_SAFETY_CRITICAL_IEC61508
OS_EXT CPU_BOOLEAN
	OSSafetyCriticalStartFlag; /* Flag indicating that all init. done        */
#endif
/* SCHEDULER -------------------------------- */
#if OS_CFG_SCHED_LOCK_TIME_MEAS_EN > 0u
OS_EXT CPU_TS_TMR
	OSSchedLockTimeBegin; /* Scheduler lock time measurement            */
OS_EXT CPU_TS_TMR OSSchedLockTimeMax;
OS_EXT CPU_TS_TMR OSSchedLockTimeMaxCur;
#endif

OS_EXT OS_NESTING_CTR
	OSSchedLockNestingCtr; /* Lock nesting level                         */
#if OS_CFG_SCHED_ROUND_ROBIN_EN > 0u
OS_EXT OS_TICK OSSchedRoundRobinDfltTimeQuanta;
OS_EXT CPU_BOOLEAN
	OSSchedRoundRobinEn; /* Enable/Disable round-robin scheduling      */
#endif
/* SEMAPHORES ------------------------------- */
#if OS_CFG_SEM_EN > 0u
#if OS_CFG_DBG_EN > 0u
...
OS_EXT CPU_BOOLEAN
	OSStatResetFlag; /* Force the reset of the computed statistics */
OS_EXT OS_CPU_USAGE
	OSStatTaskCPUUsage; /* CPU Usage in %                             */
OS_EXT OS_CPU_USAGE
	OSStatTaskCPUUsageMax; /* CPU Usage in % (Peak)                      */
...
/* TASKS ------------------------------------ */
OS_EXT OS_CTX_SW_CTR
	OSTaskCtxSwCtr; /* Number of context switches                 */
#if OS_CFG_DBG_EN > 0u
...
#if OS_CFG_TASK_REG_TBL_SIZE > 0u
OS_EXT OS_REG_ID
	OSTaskRegNextAvailID; /* Next available Task Register ID            */
#endif
...
void OSFlagCreate(OS_FLAG_GRP *p_grp, CPU_CHAR *p_name, OS_FLAGS flags,
		  OS_ERR *p_err);
...
OS_FLAGS OSFlagPost(OS_FLAG_GRP *p_grp, OS_FLAGS flags, OS_OPT opt,
		    OS_ERR *p_err);
...
void OS_FlagBlock(OS_PEND_DATA *p_pend_data, OS_FLAG_GRP *p_grp, OS_FLAGS flags,
		  OS_OPT opt, OS_TICK timeout);
...
OS_FLAGS OS_FlagPost(OS_FLAG_GRP *p_grp, OS_FLAGS flags, OS_OPT opt, CPU_TS ts,
		     OS_ERR *p_err);
...
void OSMutexPend(OS_MUTEX *p_mutex, OS_TICK timeout, OS_OPT opt, CPU_TS *p_ts,
		 OS_ERR *p_err);
...
OS_OBJ_QTY OSPendMulti(OS_PEND_DATA *p_pend_data_tbl, OS_OBJ_QTY tbl_size,
		       OS_TICK timeout, OS_OPT opt, OS_ERR *p_err);
...
void OS_PendMultiWait(OS_PEND_DATA *p_pend_data_tbl, OS_OBJ_QTY tbl_size,
		      OS_TICK timeout);
#endif
...
void OSSemCreate(OS_SEM *p_sem, CPU_CHAR *p_name, OS_SEM_CTR cnt,
		 OS_ERR *p_err);

OS_OBJ_QTY OSSemDel(OS_SEM *p_sem, OS_OPT opt, OS_ERR *p_err);

OS_SEM_CTR OSSemPend(OS_SEM *p_sem, OS_TICK timeout, OS_OPT opt, CPU_TS *p_ts,
		     OS_ERR *p_err);
...
void *OSTaskQPend(OS_TICK timeout, OS_OPT opt, OS_MSG_SIZE *p_msg_size,
		  CPU_TS *p_ts, OS_ERR *p_err);

CPU_BOOLEAN OSTaskQPendAbort(OS_TCB *p_tcb, OS_OPT opt, OS_ERR *p_err);

void OSTaskQPost(OS_TCB *p_tcb, void *p_void, OS_MSG_SIZE msg_size, OS_OPT opt,
		 OS_ERR *p_err);
...
OS_SEM_CTR OSTaskSemPend(OS_TICK timeout, OS_OPT opt, CPU_TS *p_ts,
			 OS_ERR *p_err);
...
#if OS_CFG_STAT_TASK_STK_CHK_EN > 0u
void OSTaskStkChk(OS_TCB *p_tcb, CPU_STK_SIZE *p_free, CPU_STK_SIZE *p_used,
		  OS_ERR *p_err);
#endif
...
void OS_TaskQPost(OS_TCB *p_tcb, void *p_void, OS_MSG_SIZE msg_size, OS_OPT opt,
		  CPU_TS ts, OS_ERR *p_err);
...
void OS_TLS_SetDestruct(OS_TLS_ID id, OS_TLS_DESTRUCT_PTR p_destruct,
			OS_ERR *p_err);
...
void OSTimeDlyHMSM(CPU_INT16U hours, CPU_INT16U minutes, CPU_INT16U seconds,
		   CPU_INT32U milli, OS_OPT opt, OS_ERR *p_err);
#endif
...
void OSTmrCreate(OS_TMR *p_tmr, CPU_CHAR *p_name, OS_TICK dly, OS_TICK period,
		 OS_OPT opt, OS_TMR_CALLBACK_PTR p_callback,
...
CPU_BOOLEAN OSTmrStop(OS_TMR *p_tmr, OS_OPT opt, void *p_callback_arg,
		      OS_ERR *p_err);
...
void OS_IntQPost(OS_OBJ_TYPE type, void *p_obj, void *p_void,
		 OS_MSG_SIZE msg_size, OS_FLAGS flags, OS_OPT opt, CPU_TS ts,
		 OS_ERR *p_err);
...
void *OS_MsgQGet(OS_MSG_Q *p_msg_q, OS_MSG_SIZE *p_msg_size, CPU_TS *p_ts,
		 OS_ERR *p_err);

void OS_MsgQInit(OS_MSG_Q *p_msg_q, OS_MSG_QTY size);

void OS_MsgQPut(OS_MSG_Q *p_msg_q, void *p_void, OS_MSG_SIZE msg_size,
		OS_OPT opt, CPU_TS ts, OS_ERR *p_err);

/* ---------------------------------------------- PEND/POST MANAGEMENT ---------------------------------------------- */

void OS_Pend(OS_PEND_DATA *p_pend_data, OS_PEND_OBJ *p_obj, OS_STATE pending_on,
	     OS_TICK timeout);
...
void OS_Post(OS_PEND_OBJ *p_obj, OS_TCB *p_tcb, void *p_void,
	     OS_MSG_SIZE msg_size, CPU_TS ts);

void OS_Post1(OS_PEND_OBJ *p_obj, OS_TCB *p_tcb, void *p_void,
	      OS_MSG_SIZE msg_size, CPU_TS ts);
...
void OS_PendDataInit(OS_TCB *p_tcb, OS_PEND_DATA *p_pend_data_tbl,
		     OS_OBJ_QTY tbl_size);

#if OS_CFG_DBG_EN > 0u
void OS_PendDbgNameAdd(OS_PEND_OBJ *p_obj, OS_TCB *p_tcb);
...
#else
#if (OS_CFG_SCHED_LOCK_TIME_MEAS_EN > 0u) && (OS_CFG_TS_EN < 1u)
...
#else
#if (OS_CFG_TS_EN > 0u) && (CPU_CFG_TS_EN == DEF_DISABLED)
