...
typedef unsigned char
	CPU_BOOLEAN; /*  8-bit boolean or logical                            */
typedef unsigned char
...
typedef double
	CPU_FP64; /* 64-bit floating point                                */

typedef volatile CPU_INT08U
	CPU_REG08; /*  8-bit register                                      */
typedef volatile CPU_INT16U
	CPU_REG16; /* 16-bit register                                      */
typedef volatile CPU_INT32U
	CPU_REG32; /* 32-bit register                                      */
typedef volatile CPU_INT64U
	CPU_REG64; /* 64-bit register                                      */

typedef void (*CPU_FNCT_VOID)(
	void); /* See Note #2a.                                        */
typedef void (*CPU_FNCT_PTR)(
	void *p_obj); /* See Note #2b.                                        */
...
#define CPU_CFG_ENDIAN_TYPE                                                    \
	CPU_ENDIAN_TYPE_LITTLE /* Defines CPU data    word-memory order (see Note #2). */
...
typedef CPU_DATA
	CPU_ALIGN; /* Defines CPU data-word-alignment size.                */
typedef CPU_ADDR
	CPU_SIZE_T; /* Defines CPU standard 'size_t'   size.                */
...
typedef CPU_INT32U
	CPU_STK; /* Defines CPU stack word size (in octets).             */
typedef CPU_ADDR
	CPU_STK_SIZE; /* Defines CPU stack      size (in number of CPU_STKs). */
...
#define CPU_REG_NVIC_NVIC                                                      \
	(*((CPU_REG32 *)(0xE000E004))) /* Int Ctrl'er Type Reg.                */
#define CPU_REG_NVIC_ST_CTRL                                                   \
	(*((CPU_REG32 *)(0xE000E010))) /* SysTick Ctrl & Status Reg.           */
#define CPU_REG_NVIC_ST_RELOAD                                                 \
	(*((CPU_REG32 *)(0xE000E014))) /* SysTick Reload      Value Reg.       */
#define CPU_REG_NVIC_ST_CURRENT                                                \
	(*((CPU_REG32 *)(0xE000E018))) /* SysTick Current     Value Reg.       */
#define CPU_REG_NVIC_ST_CAL                                                    \
	(*((CPU_REG32 *)(0xE000E01C))) /* SysTick Calibration Value Reg.       */

#define CPU_REG_NVIC_SETEN(n)                                                  \
	(*((CPU_REG32 *)(0xE000E100 +                                          \
			 (n)*4u))) /* IRQ Set En Reg.                      */
#define CPU_REG_NVIC_CLREN(n)                                                  \
	(*((CPU_REG32 *)(0xE000E180 +                                          \
			 (n)*4u))) /* IRQ Clr En Reg.                      */
#define CPU_REG_NVIC_SETPEND(n)                                                \
	(*((CPU_REG32 *)(0xE000E200 +                                          \
			 (n)*4u))) /* IRQ Set Pending Reg.                 */
#define CPU_REG_NVIC_CLRPEND(n)                                                \
	(*((CPU_REG32 *)(0xE000E280 +                                          \
			 (n)*4u))) /* IRQ Clr Pending Reg.                 */
#define CPU_REG_NVIC_ACTIVE(n)                                                 \
	(*((CPU_REG32 *)(0xE000E300 +                                          \
			 (n)*4u))) /* IRQ Active Reg.                      */
#define CPU_REG_NVIC_PRIO(n)                                                   \
	(*((CPU_REG32 *)(0xE000E400 +                                          \
			 (n)*4u))) /* IRQ Prio Reg.                        */

#define CPU_REG_NVIC_CPUID                                                     \
	(*((CPU_REG32 *)(0xE000ED00))) /* CPUID Base Reg.                      */
#define CPU_REG_NVIC_ICSR                                                      \
	(*((CPU_REG32 *)(0xE000ED04))) /* Int Ctrl State  Reg.                 */
#define CPU_REG_NVIC_VTOR                                                      \
	(*((CPU_REG32 *)(0xE000ED08))) /* Vect Tbl Offset Reg.                 */
#define CPU_REG_NVIC_AIRCR                                                     \
	(*((CPU_REG32 *)(0xE000ED0C))) /* App Int/Reset Ctrl Reg.              */
#define CPU_REG_NVIC_SCR                                                       \
	(*((CPU_REG32 *)(0xE000ED10))) /* System Ctrl Reg.                     */
#define CPU_REG_NVIC_CCR                                                       \
	(*((CPU_REG32 *)(0xE000ED14))) /* Cfg    Ctrl Reg.                     */
#define CPU_REG_NVIC_SHPRI1                                                    \
	(*((CPU_REG32 *)(0xE000ED18))) /* System Handlers  4 to  7 Prio.       */
#define CPU_REG_NVIC_SHPRI2                                                    \
	(*((CPU_REG32 *)(0xE000ED1C))) /* System Handlers  8 to 11 Prio.       */
#define CPU_REG_NVIC_SHPRI3                                                    \
	(*((CPU_REG32 *)(0xE000ED20))) /* System Handlers 12 to 15 Prio.       */
#define CPU_REG_NVIC_SHCSR                                                     \
	(*((CPU_REG32 *)(0xE000ED24))) /* System Handler Ctrl & State Reg.     */
#define CPU_REG_NVIC_CFSR                                                      \
	(*((CPU_REG32 *)(0xE000ED28))) /* Configurable Fault Status Reg.       */
#define CPU_REG_NVIC_HFSR                                                      \
	(*((CPU_REG32 *)(0xE000ED2C))) /* Hard  Fault Status Reg.              */
#define CPU_REG_NVIC_DFSR                                                      \
	(*((CPU_REG32 *)(0xE000ED30))) /* Debug Fault Status Reg.              */
#define CPU_REG_NVIC_MMFAR                                                     \
	(*((CPU_REG32 *)(0xE000ED34))) /* Mem Manage Addr Reg.                 */
#define CPU_REG_NVIC_BFAR                                                      \
	(*((CPU_REG32 *)(0xE000ED38))) /* Bus Fault  Addr Reg.                 */
#define CPU_REG_NVIC_AFSR                                                      \
	(*((CPU_REG32 *)(0xE000ED3C))) /* Aux Fault Status Reg.                */

#define CPU_REG_NVIC_PFR0                                                      \
	(*((CPU_REG32 *)(0xE000ED40))) /* Processor Feature Reg 0.             */
#define CPU_REG_NVIC_PFR1                                                      \
	(*((CPU_REG32 *)(0xE000ED44))) /* Processor Feature Reg 1.             */
#define CPU_REG_NVIC_DFR0                                                      \
	(*((CPU_REG32 *)(0xE000ED48))) /* Debug     Feature Reg 0.             */
#define CPU_REG_NVIC_AFR0                                                      \
	(*((CPU_REG32 *)(0xE000ED4C))) /* Aux       Feature Reg 0.             */
#define CPU_REG_NVIC_MMFR0                                                     \
	(*((CPU_REG32 *)(0xE000ED50))) /* Memory Model Feature Reg 0.          */
#define CPU_REG_NVIC_MMFR1                                                     \
	(*((CPU_REG32 *)(0xE000ED54))) /* Memory Model Feature Reg 1.          */
#define CPU_REG_NVIC_MMFR2                                                     \
	(*((CPU_REG32 *)(0xE000ED58))) /* Memory Model Feature Reg 2.          */
#define CPU_REG_NVIC_MMFR3                                                     \
	(*((CPU_REG32 *)(0xE000ED5C))) /* Memory Model Feature Reg 3.          */
#define CPU_REG_NVIC_ISAFR0                                                    \
	(*((CPU_REG32 *)(0xE000ED60))) /* ISA Feature Reg 0.                   */
#define CPU_REG_NVIC_ISAFR1                                                    \
	(*((CPU_REG32 *)(0xE000ED64))) /* ISA Feature Reg 1.                   */
#define CPU_REG_NVIC_ISAFR2                                                    \
	(*((CPU_REG32 *)(0xE000ED68))) /* ISA Feature Reg 2.                   */
#define CPU_REG_NVIC_ISAFR3                                                    \
	(*((CPU_REG32 *)(0xE000ED6C))) /* ISA Feature Reg 3.                   */
#define CPU_REG_NVIC_ISAFR4                                                    \
	(*((CPU_REG32 *)(0xE000ED70))) /* ISA Feature Reg 4.                   */
#define CPU_REG_NVIC_SW_TRIG                                                   \
	(*((CPU_REG32 *)(0xE000EF00))) /* Software Trigger Int Reg.            */

#define CPU_REG_MPU_TYPE                                                       \
	(*((CPU_REG32 *)(0xE000ED90))) /* MPU Type Reg.                        */
#define CPU_REG_MPU_CTRL                                                       \
	(*((CPU_REG32 *)(0xE000ED94))) /* MPU Ctrl Reg.                        */
#define CPU_REG_MPU_REG_NBR                                                    \
	(*((CPU_REG32 *)(0xE000ED98))) /* MPU Region Nbr Reg.                  */
#define CPU_REG_MPU_REG_BASE                                                   \
	(*((CPU_REG32 *)(0xE000ED9C))) /* MPU Region Base Addr Reg.            */
#define CPU_REG_MPU_REG_ATTR                                                   \
	(*((CPU_REG32 *)(0xE000EDA0))) /* MPU Region Attrib & Size Reg.        */

#define CPU_REG_DBG_CTRL                                                       \
	(*((CPU_REG32 *)(0xE000EDF0))) /* Debug Halting Ctrl & Status Reg.     */
#define CPU_REG_DBG_SELECT                                                     \
	(*((CPU_REG32 *)(0xE000EDF4))) /* Debug Core Reg Selector Reg.         */
#define CPU_REG_DBG_DATA                                                       \
	(*((CPU_REG32 *)(0xE000EDF8))) /* Debug Core Reg Data     Reg.         */
#define CPU_REG_DBG_INT                                                        \
	(*((CPU_REG32 *)(0xE000EDFC))) /* Debug Except & Monitor Ctrl Reg.     */
