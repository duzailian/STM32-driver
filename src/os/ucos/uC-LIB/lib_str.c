...
static const CPU_INT32U Str_MultOvfThTbl_Int32U[] = {
	...
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     1u), /*                Invalid base  1.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     2u), /* 32-bit mult ovf th for base  2.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     3u), /* 32-bit mult ovf th for base  3.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     4u), /* 32-bit mult ovf th for base  4.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     5u), /* 32-bit mult ovf th for base  5.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     6u), /* 32-bit mult ovf th for base  6.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     7u), /* 32-bit mult ovf th for base  7.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     8u), /* 32-bit mult ovf th for base  8.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     9u), /* 32-bit mult ovf th for base  9.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     10u), /* 32-bit mult ovf th for base 10.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     11u), /* 32-bit mult ovf th for base 11.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     12u), /* 32-bit mult ovf th for base 12.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     13u), /* 32-bit mult ovf th for base 13.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     14u), /* 32-bit mult ovf th for base 14.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     15u), /* 32-bit mult ovf th for base 15.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     16u), /* 32-bit mult ovf th for base 16.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     17u), /* 32-bit mult ovf th for base 17.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     18u), /* 32-bit mult ovf th for base 18.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     19u), /* 32-bit mult ovf th for base 19.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     20u), /* 32-bit mult ovf th for base 20.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     21u), /* 32-bit mult ovf th for base 21.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     22u), /* 32-bit mult ovf th for base 22.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     23u), /* 32-bit mult ovf th for base 23.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     24u), /* 32-bit mult ovf th for base 24.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     25u), /* 32-bit mult ovf th for base 25.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     26u), /* 32-bit mult ovf th for base 26.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     27u), /* 32-bit mult ovf th for base 27.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     28u), /* 32-bit mult ovf th for base 28.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     29u), /* 32-bit mult ovf th for base 29.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     30u), /* 32-bit mult ovf th for base 30.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     31u), /* 32-bit mult ovf th for base 31.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     32u), /* 32-bit mult ovf th for base 32.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     33u), /* 32-bit mult ovf th for base 33.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     34u), /* 32-bit mult ovf th for base 34.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     35u), /* 32-bit mult ovf th for base 35.  */
	(CPU_INT32U)(DEF_INT_32U_MAX_VAL /
		     36u) /* 32-bit mult ovf th for base 36.  */
};
...
static CPU_CHAR *Str_FmtNbr_Int32(CPU_INT32U nbr, CPU_INT08U nbr_dig,
				  CPU_INT08U nbr_base, CPU_BOOLEAN nbr_neg,
				  CPU_CHAR lead_char, CPU_BOOLEAN lower_case,
				  CPU_BOOLEAN nul, CPU_CHAR *pstr);

static CPU_INT32U Str_ParseNbr_Int32(const CPU_CHAR *pstr, CPU_CHAR **pstr_next,
				     CPU_INT08U nbr_base,
...
CPU_SIZE_T Str_Len(const CPU_CHAR *pstr)
{
	...
	len = Str_Len_N(pstr, DEF_INT_CPU_U_MAX_VAL);
...
CPU_SIZE_T Str_Len_N(const CPU_CHAR *pstr, CPU_SIZE_T len_max)
{
	...
	while ((pstr_len !=
		(const CPU_CHAR
			 *)0) && /* Calc str len until NULL ptr (see Note #3a) ...       */
	       (*pstr_len !=
		(CPU_CHAR)'\0') && /* ... or NULL char found      (see Note #3b) ...       */
	       (len <
		(CPU_SIZE_T)
			len_max)) { /* ... or max nbr chars srch'd (see Note #3c).          */
		pstr_len++;
		len++;
	}
...
CPU_CHAR *Str_Copy(CPU_CHAR *pstr_dest, const CPU_CHAR *pstr_src)
{
	...
	pstr_rtn = Str_Copy_N(pstr_dest, pstr_src, DEF_INT_CPU_U_MAX_VAL);
...
*/
/*$PAGE*/
CPU_CHAR *Str_Copy_N(CPU_CHAR *pstr_dest, const CPU_CHAR *pstr_src,
		     CPU_SIZE_T len_max)
{
	...
	while ((pstr_copy_dest !=
		(CPU_CHAR *)0) && /* Copy str until NULL ptr(s)  [see Note #3b]  ...      */
	       (pstr_copy_src != (const CPU_CHAR *)0) &&
	       (*pstr_copy_src !=
		(CPU_CHAR)'\0') && /* ... or NULL char found      (see Note #3c); ...      */
	       (len_copy <
		(CPU_SIZE_T)
			len_max)) { /* ... or max nbr chars copied (see Note #3d).          */
	...
	if (len_copy <
	    len_max) { /* If  copy str len < max buf len (see Note #2a2A), ... */
		*pstr_copy_dest =
			(CPU_CHAR)'\0'; /* ... copy NULL char  (see Note #3c1).                 */
	}
...
CPU_CHAR *Str_Cat(CPU_CHAR *pstr_dest, const CPU_CHAR *pstr_cat)
{
	CPU_CHAR *pstr_rtn;

	pstr_rtn = Str_Cat_N(pstr_dest, pstr_cat, DEF_INT_CPU_U_MAX_VAL);
...
*/
/*$PAGE*/
CPU_CHAR *Str_Cat_N(CPU_CHAR *pstr_dest, const CPU_CHAR *pstr_cat,
		    CPU_SIZE_T len_max)
{
	...
	if (len_max <
	    1) { /* Rtn dest str if cat len = 0 (see Note #3d2A).        */
		return ((CPU_CHAR *)pstr_dest);
	}

	pstr_cat_dest = pstr_dest;
	while ((pstr_cat_dest !=
		(CPU_CHAR *)0) && /* Adv to end of cur dest str until NULL ptr ...        */
	       (*pstr_cat_dest !=
		(CPU_CHAR)'\0')) { /* ... or NULL char found..                             */
		pstr_cat_dest++;
	}
	if (pstr_cat_dest ==
	    (CPU_CHAR *)0) { /* Rtn NULL if NULL ptr found (see Note #3b1).          */
		return ((CPU_CHAR *)0);
	}
	...
	while ((pstr_cat_dest !=
		(CPU_CHAR *)0) && /* Cat str until NULL ptr(s)  [see Note #3b]  ...       */
	       (pstr_cat_src != (const CPU_CHAR *)0) &&
	       (*pstr_cat_src !=
		(CPU_CHAR)'\0') && /* ... or NULL char found     (see Note #3c); ...       */
	       (len_cat <
		(CPU_SIZE_T)
			len_max)) { /* ... or max nbr chars cat'd (see Note #3d).           */
	...
	*pstr_cat_dest =
		(CPU_CHAR)'\0'; /* Append NULL char    (see Note #2a2C).                */
...
CPU_INT16S Str_Cmp(const CPU_CHAR *p1_str, const CPU_CHAR *p2_str)
{
	...
	cmp_val = Str_Cmp_N(p1_str, p2_str, DEF_INT_CPU_U_MAX_VAL);
...
*/
/*$PAGE*/
CPU_INT16S Str_Cmp_N(const CPU_CHAR *p1_str, const CPU_CHAR *p2_str,
		     CPU_SIZE_T len_max)
{
	...
	if (len_max <
	    1) { /* If cmp len = 0,        rtn 0       (see Note #3d1A). */
		return (0);
	}
	...
	while ((*p1_str_cmp ==
		*p2_str_cmp) && /* Cmp strs until non-matching chars (see Note #3c) ... */
	       (*p1_str_cmp !=
		(CPU_CHAR)'\0') && /* ... or NULL chars                 (see Note #3b) ... */
	       (p1_str_cmp_next !=
		(const CPU_CHAR
			 *)0) && /* ... or NULL ptr(s) found          (see Note #3a2).   */
	       (p2_str_cmp_next != (const CPU_CHAR *)0) &&
	       (cmp_len <
		(CPU_SIZE_T)
			len_max)) { /* ... or max nbr chars cmp'd        (see Note #3d2).   */
		p1_str_cmp++;
		p2_str_cmp++;
		p1_str_cmp_next++;
		p2_str_cmp_next++;
	...
	if (cmp_len ==
	    len_max) { /* If strs     identical for max len nbr of chars, ...  */
		return (0); /* ... rtn 0                 (see Note #3d2A).          */
	}

	if (*p1_str_cmp !=
	    *p2_str_cmp) { /* If strs NOT identical, ...                           */
		/* ... calc & rtn char diff  (see Note #3c1).           */
		cmp_val = (CPU_INT16S)(*p1_str_cmp) - (CPU_INT16S)(*p2_str_cmp);

	} else if (*p1_str_cmp ==
		   (CPU_CHAR)'\0') { /* If NULL char(s) found, ...                           */
		cmp_val =
			(CPU_INT16S)0; /* ... strs identical; rtn 0 (see Note #3b).            */

	} else {
		if (p1_str_cmp_next == (const CPU_CHAR *)0) {
			if (p2_str_cmp_next ==
			    (const CPU_CHAR
				     *)0) { /* If BOTH next str ptrs NULL, ...                      */
				cmp_val =
					(CPU_INT16S)0; /* ... rtn 0                       (see Note #3a2A).    */
			} else { /* If p1_str_cmp_next NULL, ...                         */
				/* ... rtn neg p2_str_cmp_next val (see Note #3a2B1).   */
				cmp_val = (CPU_INT16S)0 -
					  (CPU_INT16S)(*p2_str_cmp_next);
			}
		} else { /* If p2_str_cmp_next NULL, ...                         */
			cmp_val = (CPU_INT16S)(
				*p1_str_cmp_next); /* ... rtn pos p1_str_cmp_next val (see Note #3a2B2).   */
		}
	}
...
CPU_INT16S Str_CmpIgnoreCase(const CPU_CHAR *p1_str, const CPU_CHAR *p2_str)
{
	...
	cmp_val = Str_CmpIgnoreCase_N(p1_str, p2_str, DEF_INT_CPU_U_MAX_VAL);
...
CPU_INT16S Str_CmpIgnoreCase_N(const CPU_CHAR *p1_str, const CPU_CHAR *p2_str,
			       CPU_SIZE_T len_max)
{
	const CPU_CHAR *p1_str_cmp;
	const CPU_CHAR *p2_str_cmp;
	...
	while ((char_1 ==
		char_2) && /* Cmp strs until non-matching chars (see Note #3c) ... */
	       (*p1_str_cmp !=
		(CPU_CHAR)'\0') && /* ... or NULL chars                 (see Note #3b) ... */
	       (p1_str_cmp_next !=
		(const CPU_CHAR
	...
	if (char_1 !=
	    char_2) { /* If strs NOT identical, ...                           */
		cmp_val =
			(CPU_INT16S)char_1 -
			(CPU_INT16S)
				char_2; /* ... calc & rtn char diff  (see Note #3c1).           */
		...
		if (p1_str_cmp_next == (const CPU_CHAR *)0) {
			if (p2_str_cmp_next ==
				...
				cmp_val =
					(CPU_INT16S)0 -
					(CPU_INT16S)
						char_2; /* ... rtn neg p2_str_cmp_next val (see Note #3a2B1).   */
			}
		} else { /* If p2_str_cmp_next NULL, ...                         */
			char_1 = ASCII_ToLower(*p1_str_cmp_next);
			cmp_val = (CPU_INT16S)
				char_1; /* ... rtn pos p1_str_cmp_next val (see Note #3a2B2).   */
		}
	}
...
CPU_CHAR *Str_Char(const CPU_CHAR *pstr, CPU_CHAR srch_char)
{
	CPU_CHAR *pstr_rtn;

	pstr_rtn = Str_Char_N(pstr, DEF_INT_CPU_U_MAX_VAL, srch_char);
...
*/
/*$PAGE*/
CPU_CHAR *Str_Char_N(const CPU_CHAR *pstr, CPU_SIZE_T len_max,
		     CPU_CHAR srch_char)
{
	...
	if (pstr ==
	    (const CPU_CHAR
		     *)0) { /* Rtn NULL if srch str ptr NULL (see Note #3a1).       */
		return ((CPU_CHAR *)0);
	}

	if (len_max <
	    1) { /* Rtn NULL if srch len = 0      (see Note #3e1).       */
		return ((CPU_CHAR *)0);
	}
	...
	while ((pstr_char !=
		(const CPU_CHAR
			 *)0) && /* Srch str until NULL ptr     [see Note #3b]  ...      */
	       (*pstr_char !=
		(CPU_CHAR)'\0') && /* ... or NULL char            (see Note #3c)  ...      */
	       (*pstr_char !=
		(CPU_CHAR)
			srch_char) && /* ... or srch char found      (see Note #3d); ...      */
	       (len_srch <
		(CPU_SIZE_T)
			len_max)) { /* ... or max nbr chars srch'd (see Note #3e).          */
		pstr_char++;
		len_srch++;
	}
	...
	if (pstr_char ==
	    (const CPU_CHAR
		     *)0) { /* Rtn NULL if NULL ptr found      (see Note #3b1).     */
		return ((CPU_CHAR *)0);
	}

	if (len_srch >=
	    len_max) { /* Rtn NULL if srch char NOT found ...                  */
		return ((
			CPU_CHAR *)0); /* ... within max nbr of chars     (see Note #3e1).     */
	}

	if (*pstr_char !=
	    srch_char) { /* Rtn NULL if srch char NOT found (see Note #3c1).     */
		return ((CPU_CHAR *)0);
	}

	return ((CPU_CHAR *)
			pstr_char); /* Else rtn ptr to found srch char (see Note #3d1).     */
}
...
CPU_CHAR *Str_Char_Last(const CPU_CHAR *pstr, CPU_CHAR srch_char)
{
	...
	pstr_rtn = Str_Char_Last_N(pstr, DEF_INT_CPU_U_MAX_VAL, srch_char);
...
*/
/*$PAGE*/
CPU_CHAR *Str_Char_Last_N(const CPU_CHAR *pstr, CPU_SIZE_T len_max,
			  CPU_CHAR srch_char)
{
	const CPU_CHAR *pstr_char;
	...
	str_len_max =
		len_max -
		sizeof((CPU_CHAR)'\0'); /* Str len adj'd for NULL char len.                     */
	...
	while ((pstr_char !=
		pstr) && /* Srch str from end until beginning (see Note #3c) ... */
	       (*pstr_char !=
		srch_char)) { /* ... until srch char found         (see Note #3d).    */
		pstr_char--;
	}
...
CPU_CHAR *Str_Char_Replace(CPU_CHAR *pstr, CPU_CHAR char_srch,
			   CPU_CHAR char_replace)
{
	CPU_CHAR *pstr_rtn;

	pstr_rtn = Str_Char_Replace_N(pstr, char_srch, char_replace,
...
CPU_CHAR *Str_Char_Replace_N(CPU_CHAR *pstr, CPU_CHAR char_srch,
			     CPU_CHAR char_replace, CPU_SIZE_T len_max)
{
	CPU_CHAR *pstr_char;
	CPU_SIZE_T len;
	...
	if (pstr ==
	    (const CPU_CHAR
		     *)0) { /* Rtn NULL if srch str ptr NULL (see Note #2a1).       */
		return ((CPU_CHAR *)0);
	}

	if (len_max <
	    1) { /* Rtn NULL if srch len = 0      (see Note #2e1).       */
		return ((CPU_CHAR *)0);
	}
	...
	while ((pstr_char !=
		(const CPU_CHAR
			 *)0) && /* Srch str until NULL ptr     [see Note #2b]  ...      */
	       (*pstr_char !=
		ASCII_CHAR_NULL) && /* ... or NULL char            (see Note #2c)  ...      */
	       (len >
		0)) { /* ... or max nbr chars srch'd (see Note #2e).          */

		if (*pstr_char == char_srch) {
			*pstr_char =
				char_replace; /* Replace char if srch char is found.                  */
		}
...
*/
/*$PAGE*/
CPU_CHAR *Str_Str_N(const CPU_CHAR *pstr, const CPU_CHAR *pstr_srch,
		    CPU_SIZE_T len_max)
{
	CPU_SIZE_T str_len;
	...
	if (len_max <
	    1) { /* Rtn NULL if srch len = 0    (see Note #3g).          */
		return ((CPU_CHAR *)0);
	}
	...
	if (str_len_srch <
	    1) { /* Rtn ptr to str if srch str len = 0 (see Note #2b2).  */
		return ((CPU_CHAR *)pstr);
	}
	if (str_len_srch >
	    str_len) { /* Rtn NULL if srch str len > str len (see Note #3d).   */
		return ((CPU_CHAR *)0);
	}
	...
	srch_len =
		str_len -
		str_len_srch; /* Calc srch len (see Note #3e2).                       */
	srch_ix = 0u;
	srch_done = DEF_NO;
	...
	if (srch_cmp !=
	    0) { /* Rtn NULL if srch str NOT found (see Note #3e2).      */
		return ((CPU_CHAR *)0);
	}

	return ((CPU_CHAR *)
			pstr_srch_ix); /* Else rtn ptr to found srch str (see Note #3f1).      */
}
...
CPU_CHAR *Str_FmtNbr_Int32U(CPU_INT32U nbr, CPU_INT08U nbr_dig,
			    CPU_INT08U nbr_base, CPU_CHAR lead_char,
			    CPU_BOOLEAN lower_case, CPU_BOOLEAN nul,
			    CPU_CHAR *pstr)
{
	CPU_CHAR *pstr_fmt;

	pstr_fmt = Str_FmtNbr_Int32(
		nbr, /* Fmt unsigned int into str.                           */
		nbr_dig, nbr_base, DEF_NO, lead_char, lower_case, nul, pstr);
...
CPU_CHAR *Str_FmtNbr_Int32S(CPU_INT32S nbr, CPU_INT08U nbr_dig,
			    CPU_INT08U nbr_base, CPU_CHAR lead_char,
			    CPU_BOOLEAN lower_case, CPU_BOOLEAN nul,
			    CPU_CHAR *pstr)
{
	...
	pstr_fmt = Str_FmtNbr_Int32(
		(CPU_INT32U)
			nbr_fmt, /* Fmt signed int into str.                             */
		nbr_dig, nbr_base, nbr_neg, lead_char, lower_case, nul, pstr);
...
CPU_CHAR *Str_FmtNbr_32(CPU_FP32 nbr, CPU_INT08U nbr_dig, CPU_INT08U nbr_dp,
			CPU_CHAR lead_char, CPU_BOOLEAN nul, CPU_CHAR *pstr)
{
	CPU_CHAR *pstr_fmt;
	CPU_DATA i;
	CPU_FP32 nbr_fmt;
	...
	/* ---------------- VALIDATE FMT ARGS ----------------- */
	if (pstr ==
	    (CPU_CHAR *)0) { /* Rtn NULL if str ptr NULL (see Note #6a).             */
		return ((CPU_CHAR *)0);
	}
	...
	if ((nbr_dig < 1) &&
	    (nbr_dp <
	     1)) { /* If nbr digs/dps = 0, ...                             */
		fmt_invalid =
			DEF_YES; /* ... fmt invalid str (see Note #6b).                  */
	}

	if (lead_char != (CPU_CHAR)'\0') {
		print_char = ASCII_IsPrint(lead_char);
		if (print_char !=
		    DEF_YES) { /* If lead char non-printable  (see Note #3a1), ...     */
			fmt_invalid =
				DEF_YES; /* ... fmt invalid str         (see Note #6d).          */

		} else if (lead_char !=
			   '0') { /* Chk lead char for non-0 dig.                         */
			lead_char_dig = ASCII_IsDig(lead_char);
			if (lead_char_dig ==
			    DEF_YES) { /* If  lead char     non-0 dig (see Note #3a2A), ...    */
				fmt_invalid =
					DEF_YES; /* ... fmt invalid str         (see Note #6d).          */
			}
		}
	...
	if (fmt_invalid == DEF_NO) {
		...
		if (((nbr_dig >=
		      (nbr_dig_max +
		       nbr_neg_sign)) || /* If req'd nbr digs >= (max nbr digs + neg sign)    .. */
		     (nbr_dig_max <
		      1)) && /* .. or NO nbr digs,                                .. */
		    ((nbr_dig >
		      1) || /* .. but NOT [(req'd nbr dig = 1) AND               .. */
		     (nbr_dp >
		      0) || /* ..          (req'd nbr dp  = 0) AND               .. */
		     (nbr_neg ==
		      DEF_NO))) { /* ..          (      nbr neg    )]   (see Note #2b3).  */
			...
			lead_char_0 =
				(lead_char ==
				 '0') /* Chk if lead char a '0' dig (see Note #3b2).          */
					?
					DEF_YES :
					DEF_NO;
			...
			fmt_invalid =
				DEF_YES; /* ... fmt invalid str (see Note #6c).                  */
		}
	}
	...
	/* ------------------- FMT NBR STR -------------------- */
	for (i = nbr_dig; i > 0;
	     i--) { /* Fmt str for desired nbr digs :                       */
		if (fmt_invalid == DEF_NO) {
			if (nbr_dig_sig <
			    LIB_STR_CFG_FP_MAX_NBR_DIG_SIG) { /* If nbr sig digs < max, fmt str digs;           ...   */
				nbr_shiftd = (CPU_INT32U)(nbr_fmt / dig_exp);
				if ((nbr_shiftd >
				     0) || /* If shifted nbr > 0                          ...      */
				    (i ==
				     1u)) { /* ... OR on one's dig to fmt (see Note #3c1), ...      */
					/* ... calc & fmt dig val;                     ...      */
					if ((nbr_neg ==
					     DEF_YES) && /* If  nbr neg                     ...                  */
					    (nbr_neg_fmtd ==
					     DEF_NO)) { /* ... but neg sign NOT yet fmt'd; ...                  */

						if (lead_char_fmtd ==
						    DEF_YES) { /* ... & if lead char(s) fmt'd,    ...                  */
							pstr_fmt--; /* ... replace last lead char w/   ...                  */
						}
						*pstr_fmt++ =
							'-'; /* ... prepend neg sign (see Notes #2b & #3b).          */
					...
					if (nbr_shiftd >
						...
						*pstr_fmt++ = (CPU_CHAR)(
						...
						nbr_dig_sig++; /* ... inc nbr sig digs;      ...                       */
						    ...
						    1) || /* ... else if req'd digs > 1 ...                       */
						   (nbr_neg ==
						    DEF_NO)) { /* ... or non-neg nbr,        ...                       */
						*pstr_fmt++ =
							'0'; /* ... fmt one '0' char (see Note #3c5).                */
					}

				} else if ((nbr_neg ==
					    DEF_YES) && /* ... else if nbr neg                         ...      */
					   (lead_char_0 ==
					    DEF_YES) && /* ... & lead char a '0' dig                   ...      */
					   (nbr_neg_fmtd ==
					    DEF_NO)) { /* ... but neg sign NOT yet fmt'd,             ...      */

					*pstr_fmt++ =
						'-'; /* ... prepend neg sign (see Note #3b);        ...      */
					nbr_neg_fmtd = DEF_YES;

				} else if (lead_char !=
					   (CPU_CHAR)'\0') { /* ... else if avail,                          ...      */
					*pstr_fmt++ =
						lead_char; /* ... fmt lead char.                                   */
					lead_char_fmtd = DEF_YES;
				}

				dig_exp /=
					10.0f; /* Shift to next least-sig dig.                         */
	...
	/*$PAGE*/
	if (nbr_dp >
	    0) { /* Fmt str for desired nbr dp :                         */
		if (nbr_dig <
		    1) { /* If NO digs fmt'd;                             ...    */
			if (fmt_invalid ==
			    DEF_NO) { /* ... nbr fmt valid,                            ...    */
				if ((nbr_neg ==
				     DEF_YES) && /* ... nbr neg                                   ...    */
				    (nbr_neg_fmtd ==
				     DEF_NO)) { /* ... but neg sign NOT yet fmt'd,               ...    */
		...
		if (fmt_invalid ==
		    DEF_NO) { /* If nbr fmt valid, ...                                */
			*pstr_fmt++ =
				'.'; /* ... append dp prior to dp conversion.                */
		} else { /* Else fmt '?' for invalid str (see Note #7).          */
			*pstr_fmt++ = '?';
		}
		...
		for (i = 0u; i < nbr_dp; i++) {
			if (fmt_invalid == DEF_NO) {
				...
				if (nbr_dig_sig <
					...
					nbr_shiftd =
						(CPU_INT32U)(nbr_fmt * dp_exp);
					dig_val =
						(CPU_INT32U)(nbr_shiftd % 10u);
					*pstr_fmt++ = (CPU_CHAR)(dig_val + '0');
					dp_exp *=
						10.0f; /* Shift to next least-sig dp.                          */

					if ((nbr_shiftd >
					     0) || /* If shifted nbr > 0                  ...              */
					    (nbr_dig_sig >
					     0)) { /* ... OR  > 0 sig digs already fmt'd, ...              */
						nbr_dig_sig++; /* ... inc nbr sig digs.                                */
					}
	...
	if (nul !=
	    DEF_NO) { /* If NOT DISABLED, append NULL char (see Note #4).     */
		*pstr_fmt = (CPU_CHAR)'\0';
	}

	if (fmt_invalid !=
	    DEF_NO) { /* Rtn NULL for invalid str fmt (see Notes #6a - #6d).  */
		return ((CPU_CHAR *)0);
	}
...
CPU_INT32U Str_ParseNbr_Int32U(const CPU_CHAR *pstr, CPU_CHAR **pstr_next,
			       CPU_INT08U nbr_base)
{
	CPU_INT32U nbr;

	nbr = Str_ParseNbr_Int32(
		pstr, /* Parse/convert str ...                                */
		pstr_next, nbr_base,
...
CPU_INT32S Str_ParseNbr_Int32S(const CPU_CHAR *pstr, CPU_CHAR **pstr_next,
			       CPU_INT08U nbr_base)
{
	CPU_INT32S nbr;
	CPU_INT32U nbr_abs;
	...
	if (nbr_neg ==
	    DEF_NO) { /* Chk for neg nbr & ovf/undf (see Note #2a3A1).        */
		nbr = (nbr_abs > (CPU_INT32U)DEF_INT_32S_MAX_VAL) ?
			      (CPU_INT32S)DEF_INT_32S_MAX_VAL :
			      (CPU_INT32S)nbr_abs;
	} else {
		nbr = (nbr_abs > (CPU_INT32U)-DEF_INT_32S_MIN_VAL_ONES_CPL) ?
			      (CPU_INT32S)DEF_INT_32S_MIN_VAL :
			      -(CPU_INT32S)nbr_abs;
	}
				  ...
				  CPU_BOOLEAN nul, CPU_CHAR *pstr)
{
	...
	if (lead_char != (CPU_CHAR)'\0') {
		...
		if (print_char !=
		    DEF_YES) { /* If lead char non-printable (see Note #3a1), ...      */
			fmt_invalid =
				DEF_YES; /* ... fmt invalid str        (see Note #6e).           */

		} else if (lead_char !=
			   '0') { /* Chk lead char for non-0 nbr base dig.                */
			lead_char_delta_0 = (CPU_INT08U)(lead_char - '0');
			if (lower_case != DEF_YES) {
				lead_char_delta_a =
					(CPU_INT08U)(lead_char - 'A');
			} else {
				lead_char_delta_a =
					(CPU_INT08U)(lead_char - 'a');
			}
			...
			lead_char_dig =
				(((nbr_base <= 10u) &&
				  (lead_char_delta_0 < nbr_base)) ||
				 ((nbr_base > 10u) &&
				  ((lead_char_delta_0 < 10u) ||
				   (lead_char_delta_a < (nbr_base - 10u))))) ?
					DEF_YES :
					DEF_NO;

			if (lead_char_dig ==
			    DEF_YES) { /* If lead char non-0 nbr base dig (see Note #3a2A), ...*/
				fmt_invalid =
					DEF_YES; /* ... fmt invalid str             (see Note #6e).      */
			}
		}
	...
	if (fmt_invalid == DEF_NO) {
		...
		nbr_dig_max = 1u;
		while (nbr_log >=
		       nbr_base) { /* While nbr base digs avail, ...                       */
			nbr_dig_max++; /* ... calc max nbr digs.                               */
			nbr_log /= nbr_base;
		}
		...
		if (nbr_dig >=
			...
			if (lead_char != (CPU_CHAR)'\0') {
				...
				nbr_lead_char =
					nbr_dig - nbr_dig_min - nbr_neg_sign;
			} else {
			...
			if (nbr_lead_char >
			    0) { /* If lead chars to fmt, ...                            */
				lead_char_0 =
					(lead_char ==
					 '0') /* ... chk if lead char a '0' dig (see Note #3a2B).     */
						?
						DEF_YES :
						DEF_NO;
			} else {
	...
	/* ------------------- FMT NBR STR -------------------- */
	pstr_fmt +=
		nbr_dig_fmtd; /* Start fmt @ least-sig dig.                           */
	...
	for (i = 0u; i < nbr_dig_fmtd;
	     i++) { /* Fmt str for desired nbr digs :                       */
		if (fmt_invalid == DEF_NO) {
			if ((nbr_fmt >
			     0) || /* If fmt nbr > 0                               ...     */
			    (i ==
			     0u)) { /* ... OR on one's  dig to fmt (see Note #3c1), ...     */
				/* ... calc & fmt dig val;                      ...     */
				...
				nbr_fmt /=
					nbr_base; /* Shift to next more-sig dig.                          */

			} else if (
				(nbr_neg ==
				 DEF_YES) && /* ... else if nbr neg             AND          ...     */
				(((lead_char_0 ==
				   DEF_NO) && /* ... lead char NOT a '0' dig                  ...     */
				  (nbr_neg_fmtd ==
				   DEF_NO)) || /* ... but neg sign NOT yet fmt'd  OR           ...     */
				 ((lead_char_0 !=
				   DEF_NO) && /* ... lead char is  a '0' dig                  ...     */
				  (i ==
				   (nbr_dig_fmtd -
				    1u))))) { /* ... & on most-sig dig to fmt,                ...     */
	...
	if (fmt_invalid !=
	    DEF_NO) { /* Rtn NULL for invalid str fmt (see Notes #6a - #6e).  */
		return ((CPU_CHAR *)0);
	}
				     ...
				     CPU_BOOLEAN *pnbr_neg)
{
	...
	/* --------------- VALIDATE PARSE ARGS ---------------- */
	if (pstr_next ==
	    (CPU_CHAR **)0) { /* If NOT avail, ...                                    */
		pstr_next =
			(CPU_CHAR **)&pstr_parse_unused; /* ... re-cfg NULL rtn ptr to unused local var.         */
		(void)&pstr_parse_unused; /* Prevent possible 'variable unused' warning.          */
	}
	*pstr_next = (CPU_CHAR *)
		pstr; /* Init rtn str for err (see Note #5).                  */
	...
	if (pnbr_neg ==
		...
		pnbr_neg =
			(CPU_BOOLEAN
				 *)&nbr_neg_unused; /* ... re-cfg NULL rtn ptr to unused local var.         */
		(void)&nbr_neg_unused; /* Prevent possible 'variable unused' warning.          */
	}
	*pnbr_neg =
		DEF_NO; /* Init nbr neg for err (see Note #5).                  */

	if (pstr ==
	    (CPU_CHAR *)0) { /* Rtn zero if str ptr NULL (see Note #4b1).            */
		return (0u);
	}
	/* Rtn zero if invalid base (see Note #4a).             */
	if ((nbr_base == 1u) || (nbr_base > 36u)) {
		return (0u);
	}

	/* ------------- IGNORE PRECEDING CHAR(S) ------------- */
	pstr_parse =
		pstr; /* Save ptr to init'l str for err (see Note #2a2A2).    */

	whitespace = ASCII_IsSpace(*pstr_parse);
	while (whitespace ==
	       DEF_YES) { /* Ignore initial white-space char(s) [see Note #2a1A]. */
		pstr_parse++;
		whitespace = ASCII_IsSpace(*pstr_parse);
	}
	...
	pstr_parse_nbr =
		pstr_parse; /* Save ptr to str's nbr (see Note #2a1A1).             */
	...
	case 0u: /* Determine unspecified nbr base (see Notes #2a1B1a).  */
		if (*pstr_parse ==
			...
			case 'X':
				nbr_base =
					16u; /* ... set nbr base = 16    (see Note #2a1B1a3).        */
				parse_char = (CPU_CHAR)(*(pstr_parse + 1));
				nbr_hex = ASCII_IsDigHex(parse_char);
				if (nbr_hex ==
				    DEF_YES) { /* If next char is valid hex dig, ...                   */
			...
			default: /* For '0'  prefix, ...                                 */
				nbr_base =
					8u; /* ... set nbr base =  8    (see Note #2a1B1a2).        */
				break;
			}

		} else { /* For non-'0' prefix, ...                              */
			nbr_base =
				10u; /* ... set nbr base = 10    (see Note #2a1B1a1).        */
		}
		break;
	...
	while (done ==
	       DEF_NO) { /* Parse str for desired nbr base digs (see Note #2a2). */
		parse_char = (CPU_CHAR)*pstr_parse;
		nbr_alpha = ASCII_IsAlphaNum(parse_char);
		if (nbr_alpha ==
		    DEF_YES) { /* If valid alpha num nbr dig avail, ...                */
			...
			if (parse_dig <
			    nbr_base) { /* If parse char valid for nbr base ...                 */
				if (ovf ==
				    DEF_NO) { /* ... & nbr NOT yet ovf'd,         ...                 */
					if (nbr <=
					    Str_MultOvfThTbl_Int32U[nbr_base]) {
	...
	if (ovf ==
	    DEF_YES) { /* If nbr ovf'd, ...                                    */
		nbr = DEF_INT_32U_MAX_VAL; /* ... rtn max int val (see Note #2a3A1).               */
	}

	if (pstr_parse !=
	    pstr_parse_nbr) { /* If final parse str != init'l parse nbr str,       .. */
		*pstr_next = (CPU_CHAR *)
			pstr_parse; /* .. rtn   parse str's next char (see Note #2a2B2); .. */
	} else {
		*pstr_next = (CPU_CHAR *)
			pstr; /* .. else rtn initial parse str  (see Note #2a2A2).    */
	}

	*pnbr_neg =
		neg; /* Rtn neg nbr status.                                  */
