...
#define RAND_SEED_INIT_VAL                                                     \
	1u /* See Note #1a.                                        */

#define RAND_LCG_PARAM_M                                                       \
	0x7FFFFFFFu /* See Note #1b2B.                                      */
#define RAND_LCG_PARAM_A                                                       \
	1103515245u /* See Note #1b1A2.                                     */
#define RAND_LCG_PARAM_B                                                       \
	12345u /* See Note #1b1A3.                                     */
