...
#define DEF_TIME_NBR_HR_PER_WK                                                 \
	(DEF_TIME_NBR_HR_PER_DAY * DEF_TIME_NBR_DAY_PER_WK)
#define DEF_TIME_NBR_HR_PER_YR                                                 \
	(DEF_TIME_NBR_HR_PER_DAY * DEF_TIME_NBR_DAY_PER_YR)
#define DEF_TIME_NBR_HR_PER_YR_LEAP                                            \
	(DEF_TIME_NBR_HR_PER_DAY * DEF_TIME_NBR_DAY_PER_YR_LEAP)

#define DEF_TIME_NBR_MIN_PER_HR 60u
#define DEF_TIME_NBR_MIN_PER_DAY                                               \
	(DEF_TIME_NBR_MIN_PER_HR * DEF_TIME_NBR_HR_PER_DAY)
#define DEF_TIME_NBR_MIN_PER_WK                                                \
	(DEF_TIME_NBR_MIN_PER_DAY * DEF_TIME_NBR_DAY_PER_WK)
#define DEF_TIME_NBR_MIN_PER_YR                                                \
	(DEF_TIME_NBR_MIN_PER_DAY * DEF_TIME_NBR_DAY_PER_YR)
#define DEF_TIME_NBR_MIN_PER_YR_LEAP                                           \
	(DEF_TIME_NBR_MIN_PER_DAY * DEF_TIME_NBR_DAY_PER_YR_LEAP)
...
#define DEF_TIME_NBR_SEC_PER_WK                                                \
	(DEF_TIME_NBR_SEC_PER_DAY * DEF_TIME_NBR_DAY_PER_WK)
#define DEF_TIME_NBR_SEC_PER_YR                                                \
	(DEF_TIME_NBR_SEC_PER_DAY * DEF_TIME_NBR_DAY_PER_YR)
#define DEF_TIME_NBR_SEC_PER_YR_LEAP                                           \
	(DEF_TIME_NBR_SEC_PER_DAY * DEF_TIME_NBR_DAY_PER_YR_LEAP)
...
typedef enum lib_err {
	...
	LIB_MEM_ERR_NULL_PTR =
		10001u, /* Ptr arg(s) passed NULL ptr(s).                       */

	LIB_MEM_ERR_INVALID_MEM_SIZE =
		10100u, /* Invalid mem     size.                                */
	LIB_MEM_ERR_INVALID_MEM_ALIGN =
		10101u, /* Invalid mem     align.                               */
	LIB_MEM_ERR_INVALID_SEG_SIZE =
		10110u, /* Invalid mem seg size.                                */
	LIB_MEM_ERR_INVALID_SEG_OVERLAP =
		10111u, /* Invalid mem seg overlaps other mem seg(s).           */
	LIB_MEM_ERR_INVALID_POOL =
		10120u, /* Invalid mem pool.                                    */
	LIB_MEM_ERR_INVALID_BLK_NBR =
		10130u, /* Invalid mem pool blk nbr.                            */
	LIB_MEM_ERR_INVALID_BLK_SIZE =
		10131u, /* Invalid mem pool blk size.                           */
	LIB_MEM_ERR_INVALID_BLK_ALIGN =
		10132u, /* Invalid mem pool blk align.                          */
	LIB_MEM_ERR_INVALID_BLK_IX =
		10133u, /* Invalid mem pool ix.                                 */
	LIB_MEM_ERR_INVALID_BLK_ADDR =
		10135u, /* Invalid mem pool blk addr.                           */
	LIB_MEM_ERR_INVALID_BLK_ADDR_IN_POOL =
		10136u, /* Mem pool blk addr already in mem pool.               */

	LIB_MEM_ERR_SEG_EMPTY =
		10200u, /* Mem seg  empty; i.e. NO avail mem in seg.            */
	LIB_MEM_ERR_SEG_OVF =
		10201u, /* Mem seg  ovf;   i.e. req'd mem ovfs rem mem in seg.  */
	LIB_MEM_ERR_POOL_FULL =
		10205u, /* Mem pool full;  i.e. all mem blks avail in mem pool. */
	LIB_MEM_ERR_POOL_EMPTY =
		10206u, /* Mem pool empty; i.e. NO  mem blks avail in mem pool. */

	LIB_MEM_ERR_HEAP_EMPTY =
		10210u, /* Heap seg empty; i.e. NO avail mem in heap.           */
	LIB_MEM_ERR_HEAP_OVF =
		10211u, /* Heap seg ovf;   i.e. req'd mem ovfs rem mem in heap. */
	LIB_MEM_ERR_HEAP_NOT_FOUND =
		10215u /* Heap seg NOT found.                                  */
...
#define DEF_BIT_MASK_08(bit_mask, bit_shift)                                   \
	((CPU_INT08U)((CPU_INT08U)(bit_mask) << (bit_shift)))

#define DEF_BIT_MASK_16(bit_mask, bit_shift)                                   \
	((CPU_INT16U)((CPU_INT16U)(bit_mask) << (bit_shift)))

#define DEF_BIT_MASK_32(bit_mask, bit_shift)                                   \
	((CPU_INT32U)((CPU_INT32U)(bit_mask) << (bit_shift)))

#define DEF_BIT_MASK_64(bit_mask, bit_shift)                                   \
	((CPU_INT64U)((CPU_INT64U)(bit_mask) << (bit_shift)))
...
#define DEF_BIT_FIELD(bit_field, bit_shift)                                    \
	((((bit_field) >= DEF_INT_CPU_NBR_BITS) ? (DEF_INT_CPU_U_MAX_VAL) :    \
...
#define DEF_BIT_FIELD_08(bit_field, bit_shift)                                  \
	((CPU_INT08U)(                                                          \
		(((CPU_INT08U)(bit_field) >= (CPU_INT08U)DEF_INT_08_NBR_BITS) ? \
			 (CPU_INT08U)(DEF_INT_08U_MAX_VAL) :                    \
			 (CPU_INT08U)(DEF_BIT08(bit_field) - (CPU_INT08U)1u))   \
		<< (bit_shift)))

#define DEF_BIT_FIELD_16(bit_field, bit_shift)                                  \
	((CPU_INT16U)(                                                          \
		(((CPU_INT16U)(bit_field) >= (CPU_INT16U)DEF_INT_16_NBR_BITS) ? \
			 (CPU_INT16U)(DEF_INT_16U_MAX_VAL) :                    \
			 (CPU_INT16U)(DEF_BIT16(bit_field) - (CPU_INT16U)1u))   \
		<< (bit_shift)))

#define DEF_BIT_FIELD_32(bit_field, bit_shift)                                  \
	((CPU_INT32U)(                                                          \
		(((CPU_INT32U)(bit_field) >= (CPU_INT32U)DEF_INT_32_NBR_BITS) ? \
			 (CPU_INT32U)(DEF_INT_32U_MAX_VAL) :                    \
			 (CPU_INT32U)(DEF_BIT32(bit_field) - (CPU_INT32U)1u))   \
		<< (bit_shift)))

#define DEF_BIT_FIELD_64(bit_field, bit_shift)                                  \
	((CPU_INT64U)(                                                          \
		(((CPU_INT64U)(bit_field) >= (CPU_INT64U)DEF_INT_64_NBR_BITS) ? \
			 (CPU_INT64U)(DEF_INT_64U_MAX_VAL) :                    \
...
#define DEF_BIT_SET_08(val, mask)                                              \
	((val) = (CPU_INT08U)(((CPU_INT08U)(val)) | ((CPU_INT08U)(mask))))

#define DEF_BIT_SET_16(val, mask)                                              \
	((val) = (CPU_INT16U)(((CPU_INT16U)(val)) | ((CPU_INT16U)(mask))))

#define DEF_BIT_SET_32(val, mask)                                              \
	((val) = (CPU_INT32U)(((CPU_INT32U)(val)) | ((CPU_INT32U)(mask))))

#define DEF_BIT_SET_64(val, mask)                                              \
	((val) = (CPU_INT64U)(((CPU_INT64U)(val)) | ((CPU_INT64U)(mask))))
...
#define DEF_BIT_SET(val, mask)                                                 \
	((sizeof(val) == CPU_WORD_SIZE_08) ? DEF_BIT_SET_08(val, mask) : 0)

#elif (CPU_CFG_DATA_SIZE_MAX == CPU_WORD_SIZE_16)

#define DEF_BIT_SET(val, mask)                                                 \
	((sizeof(val) == CPU_WORD_SIZE_08) ?                                   \
		 DEF_BIT_SET_08(val, mask) :                                   \
		 ((sizeof(val) == CPU_WORD_SIZE_16) ?                          \
...
#define DEF_BIT_CLR_08(val, mask)                                              \
	((val) = (CPU_INT08U)(((CPU_INT08U)(val)) & ((CPU_INT08U) ~(mask))))

#define DEF_BIT_CLR_16(val, mask)                                              \
	((val) = (CPU_INT16U)(((CPU_INT16U)(val)) & ((CPU_INT16U) ~(mask))))

#define DEF_BIT_CLR_32(val, mask)                                              \
	((val) = (CPU_INT32U)(((CPU_INT32U)(val)) & ((CPU_INT32U) ~(mask))))

#define DEF_BIT_CLR_64(val, mask)                                              \
	((val) = (CPU_INT64U)(((CPU_INT64U)(val)) & ((CPU_INT64U) ~(mask))))
...
#define DEF_BIT_CLR(val, mask)                                                 \
	((sizeof(val) == CPU_WORD_SIZE_08) ? DEF_BIT_CLR_08(val, mask) : 0)
...
#define DEF_BIT_IS_SET(val, mask)                                              \
	((((mask) != 0u) && (((val) & (mask)) == (mask))) ? (DEF_YES) :        \
							    (DEF_NO))
...
#define DEF_BIT_IS_CLR(val, mask)                                              \
	((((mask) != 0u) && (((val) & (mask)) == 0u)) ? (DEF_YES) : (DEF_NO))
...
#define DEF_BIT_IS_SET_ANY(val, mask)                                          \
	((((val) & (mask)) == 0u) ? (DEF_NO) : (DEF_YES))
...
#define DEF_BIT_IS_CLR_ANY(val, mask)                                          \
	((((val) & (mask)) == (mask)) ? (DEF_NO) : (DEF_YES))
...
#define DEF_CHK_VAL_MIN(val, val_min)                                          \
	(((!(((val) >= 1) && ((val_min) < 1))) &&                              \
	  ((((val_min) >= 1) && ((val) < 1)) || ((val) < (val_min)))) ?        \
		 DEF_FAIL :                                                    \
		 DEF_OK)
...
#define DEF_CHK_VAL_MAX(val, val_max)                                          \
	(((!(((val_max) >= 1) && ((val) < 1))) &&                              \
	  ((((val) >= 1) && ((val_max) < 1)) || ((val) > (val_max)))) ?        \
		 DEF_FAIL :                                                    \
		 DEF_OK)
...
#define DEF_CHK_VAL(val, val_min, val_max)                                     \
	(((DEF_CHK_VAL_MIN(val, val_min) == DEF_FAIL) ||                       \
...
#define DEF_GET_U_MAX_VAL(obj)                                                 \
	((sizeof(obj) == CPU_WORD_SIZE_08) ? DEF_INT_08U_MAX_VAL : 0)

#elif (CPU_CFG_DATA_SIZE_MAX == CPU_WORD_SIZE_16)

#define DEF_GET_U_MAX_VAL(obj)                                                 \
	((sizeof(obj) == CPU_WORD_SIZE_08) ?                                   \
		 DEF_INT_08U_MAX_VAL :                                         \
...
#define DEF_GET_U_MAX_VAL(obj)                                                 \
	((sizeof(obj) == CPU_WORD_SIZE_08) ?                                   \
		 DEF_INT_08U_MAX_VAL :                                         \
		 ((sizeof(obj) == CPU_WORD_SIZE_16) ?                          \
			  DEF_INT_16U_MAX_VAL :                                \
			  ((sizeof(obj) == CPU_WORD_SIZE_32) ?                 \
				   DEF_INT_32U_MAX_VAL :                       \
				   0)))
