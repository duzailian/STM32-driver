...
struct mem_pool {
	LIB_MEM_TYPE
		Type; /* Pool type : LIB_TYPE_POOL or LIB_TYPE_HEAP.          */
	...
	MEM_POOL_IX
		BlkIx; /* Ix  into mem pool's array of blk ptrs.               */
	CPU_SIZE_T
		PoolSize; /* Size  of mem pool        (in octets).                */
	MEM_POOL_BLK_QTY
		BlkNbr; /* Nbr   of mem pool   blks.                            */
	CPU_SIZE_T
		BlkSize; /* Size  of mem pool   blks (in octets).                */
	CPU_SIZE_T
		BlkAlign; /* Align of mem pool   blks (in octets).                */

	/* --------------------- MEM SEG ---------------------- */
	void *SegAddr; /* Ptr      to mem seg's base/start addr.               */
	void *SegAddrNextAvail; /* Ptr      to mem seg's next avail addr.               */
	CPU_SIZE_T
		SegSizeTot; /* Tot size of mem seg (in octets).                     */
	CPU_SIZE_T
		SegSizeRem; /* Rem size of mem seg (in octets).                     */
};
...
#define MEM_VAL_BIG_TO_LITTLE_16(val)                                          \
	((CPU_INT16U)(                                                         \
		((CPU_INT16U)((((CPU_INT16U)(val)) & (CPU_INT16U)0xFF00u) >>   \
			      (1u * DEF_OCTET_NBR_BITS))) |                    \
		((CPU_INT16U)((((CPU_INT16U)(val)) & (CPU_INT16U)0x00FFu)      \
			      << (1u * DEF_OCTET_NBR_BITS)))))

#define MEM_VAL_BIG_TO_LITTLE_32(val)                                          \
	((CPU_INT32U)(                                                         \
		((CPU_INT32U)(                                                 \
			(((CPU_INT32U)(val)) & (CPU_INT32U)0xFF000000u) >>     \
			(3u * DEF_OCTET_NBR_BITS))) |                          \
		((CPU_INT32U)(                                                 \
			(((CPU_INT32U)(val)) & (CPU_INT32U)0x00FF0000u) >>     \
			(1u * DEF_OCTET_NBR_BITS))) |                          \
		((CPU_INT32U)((((CPU_INT32U)(val)) & (CPU_INT32U)0x0000FF00u)  \
			      << (1u * DEF_OCTET_NBR_BITS))) |                 \
		((CPU_INT32U)((((CPU_INT32U)(val)) & (CPU_INT32U)0x000000FFu)  \
			      << (3u * DEF_OCTET_NBR_BITS)))))
...
#define MEM_VAL_BIG_TO_LITTLE_32(val)                                          \
	((CPU_INT32U)(                                                         \
		((CPU_INT32U)(                                                 \
			(((CPU_INT32U)(val)) & (CPU_INT32U)0xFF000000u) >>     \
			(1u * DEF_OCTET_NBR_BITS))) |                          \
		((CPU_INT32U)((((CPU_INT32U)(val)) & (CPU_INT32U)0x00FF0000u)  \
			      << (1u * DEF_OCTET_NBR_BITS))) |                 \
		((CPU_INT32U)(                                                 \
			(((CPU_INT32U)(val)) & (CPU_INT32U)0x0000FF00u) >>     \
			(1u * DEF_OCTET_NBR_BITS))) |                          \
		((CPU_INT32U)((((CPU_INT32U)(val)) & (CPU_INT32U)0x000000FFu)  \
			      << (1u * DEF_OCTET_NBR_BITS)))))
...
#define MEM_VAL_GET_INT08U_BIG(addr)                                           \
	((CPU_INT08U)(                                                         \
		(CPU_INT08U)(((CPU_INT08U)(*(((CPU_INT08U *)(addr)) + 0)))     \
			     << (0u * DEF_OCTET_NBR_BITS))))

#define MEM_VAL_GET_INT16U_BIG(addr)                                           \
	((CPU_INT16U)(                                                         \
		((CPU_INT16U)(((CPU_INT16U)(*(((CPU_INT08U *)(addr)) + 0)))    \
			      << (1u * DEF_OCTET_NBR_BITS))) +                 \
		((CPU_INT16U)(((CPU_INT16U)(*(((CPU_INT08U *)(addr)) + 1)))    \
			      << (0u * DEF_OCTET_NBR_BITS)))))

#define MEM_VAL_GET_INT32U_BIG(addr)                                           \
	((CPU_INT32U)(                                                         \
		((CPU_INT32U)(((CPU_INT32U)(*(((CPU_INT08U *)(addr)) + 0)))    \
			      << (3u * DEF_OCTET_NBR_BITS))) +                 \
		((CPU_INT32U)(((CPU_INT32U)(*(((CPU_INT08U *)(addr)) + 1)))    \
			      << (2u * DEF_OCTET_NBR_BITS))) +                 \
		((CPU_INT32U)(((CPU_INT32U)(*(((CPU_INT08U *)(addr)) + 2)))    \
			      << (1u * DEF_OCTET_NBR_BITS))) +                 \
		((CPU_INT32U)(((CPU_INT32U)(*(((CPU_INT08U *)(addr)) + 3)))    \
			      << (0u * DEF_OCTET_NBR_BITS)))))

#define MEM_VAL_GET_INT08U_LITTLE(addr)                                        \
	((CPU_INT08U)(                                                         \
		(CPU_INT08U)(((CPU_INT08U)(*(((CPU_INT08U *)(addr)) + 0)))     \
			     << (0u * DEF_OCTET_NBR_BITS))))
...
#define MEM_VAL_SET_INT08U_BIG(addr, val)                                      \
	do {                                                                   \
		(*(((CPU_INT08U *)(addr)) + 0)) = ((CPU_INT08U)(               \
			(((CPU_INT08U)(val)) & (CPU_INT08U)0xFFu) >>           \
			(0u * DEF_OCTET_NBR_BITS)));                           \
	} while (0)
...
#define MEM_VAL_SET_INT16U_BIG(addr, val)                                      \
	do {                                                                   \
		(*(((CPU_INT08U *)(addr)) + 0)) = ((CPU_INT08U)(               \
			(((CPU_INT16U)(val)) & (CPU_INT16U)0xFF00u) >>         \
			(1u * DEF_OCTET_NBR_BITS)));                           \
		(*(((CPU_INT08U *)(addr)) + 1)) = ((CPU_INT08U)(               \
			(((CPU_INT16U)(val)) & (CPU_INT16U)0x00FFu) >>         \
			(0u * DEF_OCTET_NBR_BITS)));                           \
	} while (0)
...
#define MEM_VAL_SET_INT32U_BIG(addr, val)                                      \
	do {                                                                   \
		...
		(*(((CPU_INT08U *)(addr)) + 1)) = ((CPU_INT08U)(               \
			(((CPU_INT32U)(val)) & (CPU_INT32U)0x00FF0000u) >>     \
			(2u * DEF_OCTET_NBR_BITS)));                           \
		(*(((CPU_INT08U *)(addr)) + 2)) = ((CPU_INT08U)(               \
			(((CPU_INT32U)(val)) & (CPU_INT32U)0x0000FF00u) >>     \
			(1u * DEF_OCTET_NBR_BITS)));                           \
		(*(((CPU_INT08U *)(addr)) + 3)) = ((CPU_INT08U)(               \
			(((CPU_INT32U)(val)) & (CPU_INT32U)0x000000FFu) >>     \
			(0u * DEF_OCTET_NBR_BITS)));                           \
	} while (0)

#define MEM_VAL_SET_INT08U_LITTLE(addr, val)                                   \
	do {                                                                   \
		(*(((CPU_INT08U *)(addr)) + 0)) = ((CPU_INT08U)(               \
			(((CPU_INT08U)(val)) & (CPU_INT08U)0xFFu) >>           \
			(0u * DEF_OCTET_NBR_BITS)));                           \
...
#define MEM_VAL_COPY_GET_INT08U_BIG(addr_dest, addr_src)                       \
	do {                                                                   \
		(*(((CPU_INT08U *)(addr_dest)) + 0)) =                         \
			(*(((CPU_INT08U *)(addr_src)) + 0));                   \
	} while (0)
...
#define MEM_VAL_COPY_GET_INT16U_BIG(addr_dest, addr_src)                       \
	do {                                                                   \
		(*(((CPU_INT08U *)(addr_dest)) + 0)) =                         \
			(*(((CPU_INT08U *)(addr_src)) + 0));                   \
		(*(((CPU_INT08U *)(addr_dest)) + 1)) =                         \
			(*(((CPU_INT08U *)(addr_src)) + 1));                   \
	} while (0)
...
#define MEM_VAL_COPY_GET_INT32U_BIG(addr_dest, addr_src)                       \
	do {                                                                   \
		...
		(*(((CPU_INT08U *)(addr_dest)) + 1)) =                         \
			(*(((CPU_INT08U *)(addr_src)) + 1));                   \
		(*(((CPU_INT08U *)(addr_dest)) + 2)) =                         \
			(*(((CPU_INT08U *)(addr_src)) + 2));                   \
		(*(((CPU_INT08U *)(addr_dest)) + 3)) =                         \
			(*(((CPU_INT08U *)(addr_src)) + 3));                   \
	} while (0)
...
#define MEM_VAL_COPY_GET_INT08U(addr_dest, addr_src)                           \
	MEM_VAL_COPY_GET_INT08U_BIG(addr_dest, addr_src)
#define MEM_VAL_COPY_GET_INT16U(addr_dest, addr_src)                           \
	MEM_VAL_COPY_GET_INT16U_BIG(addr_dest, addr_src)
#define MEM_VAL_COPY_GET_INT32U(addr_dest, addr_src)                           \
...
#define MEM_VAL_COPY_GET_INTU_BIG(addr_dest, addr_src, val_size)               \
	do {                                                                   \
		...
		for (_i = 0; _i < (val_size); _i++) {                          \
			(*(((CPU_INT08U *)(addr_dest)) + _i)) =                \
				(*(((CPU_INT08U *)(addr_src)) + _i));          \
		}                                                              \
	} while (0)
...
#define MEM_VAL_COPY_GET_INTU_LITTLE(addr_dest, addr_src, val_size)            \
	do {                                                                   \
		...
		for (_i = 0; _i < (val_size); _i++) {                          \
			(*(((CPU_INT08U *)(addr_dest)) + _i)) =                \
				(*(((CPU_INT08U *)(addr_src)) + _j));          \
			_j--;                                                  \
		}                                                              \
	} while (0)

#define MEM_VAL_COPY_GET_INTU(addr_dest, addr_src, val_size)                   \
...
/* See Note #5.                                 */
#define MEM_VAL_COPY_SET_INT08U_BIG(addr_dest, addr_src)                       \
	MEM_VAL_COPY_GET_INT08U_BIG(addr_dest, addr_src)
#define MEM_VAL_COPY_SET_INT16U_BIG(addr_dest, addr_src)                       \
	MEM_VAL_COPY_GET_INT16U_BIG(addr_dest, addr_src)
#define MEM_VAL_COPY_SET_INT32U_BIG(addr_dest, addr_src)                       \
	MEM_VAL_COPY_GET_INT32U_BIG(addr_dest, addr_src)

#define MEM_VAL_COPY_SET_INT08U_LITTLE(addr_dest, addr_src)                    \
	MEM_VAL_COPY_GET_INT08U_LITTLE(addr_dest, addr_src)
#define MEM_VAL_COPY_SET_INT16U_LITTLE(addr_dest, addr_src)                    \
	MEM_VAL_COPY_GET_INT16U_LITTLE(addr_dest, addr_src)
#define MEM_VAL_COPY_SET_INT32U_LITTLE(addr_dest, addr_src)                    \
	MEM_VAL_COPY_GET_INT32U_LITTLE(addr_dest, addr_src)

#define MEM_VAL_COPY_SET_INT08U(addr_dest, addr_src)                           \
	MEM_VAL_COPY_GET_INT08U(addr_dest, addr_src)
#define MEM_VAL_COPY_SET_INT16U(addr_dest, addr_src)                           \
	MEM_VAL_COPY_GET_INT16U(addr_dest, addr_src)
#define MEM_VAL_COPY_SET_INT32U(addr_dest, addr_src)                           \
...
/* See Note #5.                                 */
#define MEM_VAL_COPY_SET_INTU_BIG(addr_dest, addr_src, val_size)               \
	MEM_VAL_COPY_GET_INTU_BIG(addr_dest, addr_src, val_size)
#define MEM_VAL_COPY_SET_INTU_LITTLE(addr_dest, addr_src, val_size)            \
	MEM_VAL_COPY_GET_INTU_LITTLE(addr_dest, addr_src, val_size)
#define MEM_VAL_COPY_SET_INTU(addr_dest, addr_src, val_size)                   \
...
#define MEM_VAL_COPY_08(addr_dest, addr_src)                                   \
	do {                                                                   \
		(*(((CPU_INT08U *)(addr_dest)) + 0)) =                         \
			(*(((CPU_INT08U *)(addr_src)) + 0));                   \
	} while (0)
...
#define MEM_VAL_COPY(addr_dest, addr_src, val_size)                            \
	do {                                                                   \
		CPU_SIZE_T _i;                                                 \
                                                                               \
		for (_i = 0; _i < (val_size); _i++) {                          \
...
MEM_POOL_IX Mem_PoolBlkIxGet(MEM_POOL *pmem_pool, void *pmem_blk,
			     LIB_ERR *perr);
